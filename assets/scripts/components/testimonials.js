...
let testimonials_data = {
  en: {
    ...
    user1: {
      ...
      "stars": 5,
      "usermg": "assets/images/testimonials/Sophia-J.png",
    },
    user2: {
      "user": "Emily Brown",
      ...
      "stars": 5,
      "user-img": "assets/images/testimonials/Emily-B.png",
    ...
    user3: {
      ...
      "stars": 5,
      "user-img": "assets/images/testimonials/Olga-P.png",
    }
    ,
    user4: {
      "user": "Rashad Aliyev",
      ...
      "stars": 5,
      "user-img": "assets/images/testimonials/Rashad-A.png",
    },
    user5: {
      "user": "Leyla Huseynli",
      ...
      "stars": 5,
      "user-img": "assets/images/testimonials/Leyla-H.png",
    }
  },
  az: {
    "title": "Rəylər",
    user1: {
      ...
      "stars": 5,
      "user-img": "assets/images/testimonials/Sophia-J.png",
    },
    user2: {
      "user": "Emili Braun",
...
currentTestimonialsData.map((user, index) => {
